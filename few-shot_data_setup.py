...
wsj_sent_jumble = pd.read_csv("WSJ_Dataset/sentence_jumbling_train.csv", index_col=0)
wsj_para_jumble = pd.read_csv("WSJ_Dataset/para_jumbling_train.csv", index_col=0)
...
json.dump(wsj_sent_jumble_few_shot_idxs, open("WSJ_Dataset/sentence_jumbling_few_shot_idxs.json", 'w'))
json.dump(wsj_para_jumble_few_shot_idxs, open("WSJ_Dataset/para_jumbling_few_shot_idxs.json", 'w'))
